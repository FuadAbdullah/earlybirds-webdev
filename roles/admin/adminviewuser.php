...
$_sql = 'SELECT * FROM user ORDER BY uid';
...
if (isset($_POST['filter']))
{
    ...
    {
        $_sql = 'SELECT * FROM user WHERE uid LIKE "%' . $_POST['filter'] . '%" or
    ...
    else if ($_POST['sort'] == 'FirstNameDesc')
    {
        $_sql = 'SELECT * FROM user WHERE uid LIKE "%' . $_POST['filter'] . '%" or
                                    first_name LIKE "%' . $_POST['filter'] . '%" or
                                    last_name LIKE "%' . $_POST['filter'] . '%" or
...
<head>
    ...
    <meta name="description" content="View list of registered users">
    ...
    <main style="background-color: #FFEBC6;position: relative;min-height: 1000px;">
        <div style="background-color: #f15946;height: 200px;padding-top: 200px;">
            ...
            <div style="position: absolute;top: 105px;left: 35px;">
                <h2 style="color: rgb(255,255,255);font-family: Montserrat, sans-serif;font-weight: 500;font-size: 50px;">Users List</h2>
            </div>
            ...
            <div style="position: absolute;top: 105px;left: 1350px;width: 350px;"><a class="btn btn-primary shadow" role="button" style="background-color: #FFB100;color: #FFFFFF;font-family: Montserrat, sans-serif;font-size: 34px;font-weight: 600;padding-right: 50px;padding-left: 50px;border-radius: 30px;border-color: rgba(255,255,255, 0);"
                href="../user/register.html">Add User</a></div>
            <div
                style="position: absolute;top: 105px;left: 650px;width: 350px;"><a class="btn btn-primary shadow" role="button" style="background-color: #FFB100;color: #FFFFFF;font-family: Montserrat, sans-serif;font-size: 34px;font-weight: 600;padding-right: 50px;padding-left: 50px;border-radius: 30px;border-color: rgba(255,255,255, 0);"
                    href="adminviewadmin.php">View Admin</a></div>
        ...
        <div style="position: absolute;top: 105px;left: 980px;width: 360px;"><a class="btn btn-primary shadow" role="button" style="background-color: #FFB100;color: #FFFFFF;font-family: Montserrat, sans-serif;font-size: 34px;font-weight: 600;padding-right: 50px;padding-left: 50px;border-radius: 30px;border-color: rgba(255,255,255, 0);"
                href="adminviewam.php">View Manager</a></div>
        </div>
        <div style="height: 120px;">
            <form method="post" action="adminviewuser.php">
                ...
                <div
                        style="position: absolute;top: 240px;left: 1000px;width: 600px;"><select class="border-white shadow form-control form-control-lg" style="font-family: Montserrat, sans-serif;font-size: 40px; border-radius: 30px;" name="sort" required="">
                            ...
                            <option value="FirstName">By First Name (Ascending)</option>
                            <option value="FirstNameDesc">By First Name (Descending)</option>
                        ...
                        <tbody style="color: rgb(255,255,255);">
                            ...
                            if(mysqli_affected_rows($_conn)>0){
                                for($i = 0; $i<mysqli_num_rows($_results); $i++){
                                    ...
                                    echo '<tr>';
                                    echo '<td><a href = "userprofile.php?uid='.$row['uid'].'">
                                    ...
                                    echo '<td><a href = "../../php/admindeleteuser.php?uid='.$row['uid'].'">
