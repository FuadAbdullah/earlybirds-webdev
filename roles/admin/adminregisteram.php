...
<head>
    ...
    <title>Register an Airport Manager</title>
    <meta name="description" content="Registering an airport manager">
...
<div style="background-color: #f15946;height: 200px;padding-top: 200px;">
        ...
        <div style="position: absolute;top: 105px;left: 35px;">
            <h2 style="color: rgb(255,255,255);font-family: Montserrat, sans-serif;font-weight: 500;font-size: 50px;">Register Airport Manager</h2>
        </div>
    ...
    <div class="card">
        <div class="card-body" style="background-color: #B7B5E4;height: 1600px;">
            ...
            <div class="container" style="position: absolute;top: 140px;left: 435px;width: 1000px;padding-left: 60px;">
                <h1 class="text-center" style="font-family: Montserrat, sans-serif;">Register Airport Manager</h1>
            </div>
            ...
            <form method="post" action="../../php/adminregisteram.php"  style="position: absolute;top: 170px;left: 640px;min-width: 620px;">
                <input class="border-white shadow form-control form-control-lg" type="text" style="font-family: Montserrat, sans-serif;font-size: 40px;position: absolute;top: 160px;left: 10px;" placeholder="John Arbuckle" required="" name="mgrname" minlength="3"
                    maxlength="40"><input class="border-white shadow form-control form-control-lg" type="text" style="font-family: Montserrat, sans-serif;font-size: 40px;position: absolute;top: 330px;left: 10px;" placeholder="johnbuckle" required="" name="mgrusr"
                    minlength="6" maxlength="24"><input class="shadow form-control form-control-lg" type="password" style="position: absolute;top: 495px;left: 10px;font-family: Montserrat, sans-serif;font-size: 40px;" size="25" placeholder="********" required=""
                    name="mgrpass" maxlength="16" minlength="6"><input class="shadow form-control form-control-lg" type="password" style="position: absolute;top: 665px;left: 10px;font-family: Montserrat, sans-serif;font-size: 40px;" size="25" placeholder="********"
                    required="" name="mgrreppass" maxlength="16" minlength="6">
                    <input class="border-white shadow form-control form-control-lg" type="tel" style="position: absolute;top: 825px;left: 10px;font-family: Montserrat, sans-serif;font-size: 40px;" placeholder="0176503929" required="" name="mgrcontact" minlength="5"
                    maxlength="14"><input class="border-white shadow form-control form-control-lg" type="email" style="position: absolute;top: 1000px;left: 10px;font-family: Montserrat, sans-serif;font-size: 40px;" required="" placeholder="johnarbuckle@gmail.com" name="mgremail"
