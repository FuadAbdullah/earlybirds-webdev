...
$_sql = 'SELECT * FROM airport_manager ORDER BY amid';
...
if (isset($_POST['filter']))
{
    ...
    {
        $_sql = 'SELECT * FROM airport_manager WHERE amid LIKE "%' . $_POST['filter'] . '%" or
...
<head>
    ...
    <title>View Airport Managers</title>
    <meta name="description" content="View list of registered airport managers">
    ...
    <main style="background-color: #FFEBC6;position: relative;min-height: 1000px;">
        <div style="background-color: #f15946;height: 200px;padding-top: 200px;">
            ...
            <div style="position: absolute;top: 105px;left: 35px;">
                <h2 style="color: rgb(255,255,255);font-family: Montserrat, sans-serif;font-weight: 500;font-size: 50px;">Airport Managers List</h2>
            </div>
            ...
            <div style="position: absolute;top: 105px;left: 1280px;width: 350px;"><a class="btn btn-primary shadow" role="button" style="background-color: #FFB100;color: #FFFFFF;font-family: Montserrat, sans-serif;font-size: 34px;font-weight: 600;padding-right: 50px;padding-left: 50px;border-radius: 30px;border-color: rgba(255,255,255, 0);"
                    href="adminregisteram.php">Add Manager</a></div>
            <div style="position: absolute;top: 105px;left: 640px;width: 350px;"><a class="btn btn-primary shadow" role="button" style="background-color: #FFB100;color: #FFFFFF;font-family: Montserrat, sans-serif;font-size: 34px;font-weight: 600;padding-right: 50px;padding-left: 50px;border-radius: 30px;border-color: rgba(255,255,255, 0);"
            ...
            <div style="position: absolute;top: 105px;left: 970px;width: 360px;"><a class="btn btn-primary shadow" role="button" style="background-color: #FFB100;color: #FFFFFF;font-family: Montserrat, sans-serif;font-size: 34px;font-weight: 600;padding-right: 50px;padding-left: 50px;border-radius: 30px;border-color: rgba(255,255,255, 0);"
                    href="adminviewuser.php">View Users</a></div>
        </div>
        <div style="height: 120px;">
            <form method="post" action="adminviewam.php">
                           ...
                           <?php
                            ...
                            if(mysqli_affected_rows($_conn)>0){
                                for($i = 0; $i<mysqli_num_rows($_results); $i++){
                                    ...
                                    echo '<tr>';
                                    echo '<td><a href = "amprofile.php?amid='.$row['amid'].'">
                                    ...
                                    echo '<td><a href = "../../php/admindeleteam.php?amid='.$row['amid'].'">
                                    ...
                                    echo '<td>'.sprintf('%05d', $row['amid']).'</td>';
