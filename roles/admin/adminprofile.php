...
$_sql = 'SELECT * FROM admin WHERE aid = "' . $_GET['aid'] .  '"';
...
if (!mysqli_num_rows($_fetch) == 1)
{
    ...
    ('
        <script>
            ...
            window.location.href = "adminviewadmin.php";
...
<head>
    ...
    <meta name="description" content="Registered administrator profile">
...
<body>
    <div style="background-color: #f15946;height: 200px;padding-top: 200px;">
        ...
        <div style="position: absolute;top: 105px;left: 35px;">
            <h2 style="color: rgb(255,255,255);font-family: Montserrat, sans-serif;font-weight: 500;font-size: 50px;">Administrator Profile</h2>
        </div>
    ...
    <main style="background-color: #FFEBC6;position: relative;min-height: 1000px;">
        <div style="padding-top: 100px;padding-bottom: 30px;padding-left: 30px;"><img src="../../assets/img/profile-white/bgred.png" height="800px" width="800px" style="position: absolute;top: 100px;left: 100px;height: 750px;width: 810px;">
            <form style="position: absolute;top: 165px;left: 105px;" action="../../php/adminupdetails.php" method="post">
                <div style="position: absolute;top: 100px;left: 50px;width: 690px;"><input class="border-white shadow form-control form-control-lg" type="text" size="25" style="font-family: Montserrat, sans-serif;font-size: 40px;" value="<?php echo $_fullname; ?>" placeholder="John Arbuckle" name="admname" minlength="3" maxlength="40"></div>
                <div style="position: absolute;top: 240px;left: 50px;width: 690px;"><input class="border-white shadow form-control form-control-lg" type="tel" style="font-family: Montserrat, sans-serif;font-size: 40px;" value="<?php echo $_contact; ?>" placeholder="0176503929" name="admcontact" maxlength="14" minlength="3"></div>
                <div style="position: absolute;top: 400px;left: 50px;width: 690px;"><input class="shadow form-control form-control-lg" type="email" style="font-family: Montserrat, sans-serif;font-size: 40px;" value="<?php echo $_email; ?>" placeholder="john_arbuckle@gmail.com" name="admemail" minlength="3" maxlength="24"></div>
                <div style="position: absolute;top: 530px;left: 50px;width: 690px;"><button class="btn btn-primary btn-block border-white shadow" type="submit" style="background-color: #ffebc6;color: #f15946;font-family: Montserrat, sans-serif;font-size: 34px;font-weight: 600;padding-right: 50px;padding-left: 50px;border-radius: 30px;"><input type="hidden" name="aid" value="<?php echo $_GET['aid']; ?>"/>Save Changes</button></div>
            </form>
        ...
        <div style="padding-top: 100px;padding-bottom: 30px;padding-left: 1000px;"><img src="../../assets/img/profile-white/bgmust.png" width="800px" height="800px" style="position: absolute;top: 100px;left: 990px;height: 750px;width: 810px;">
            ...
            <form style="position: absolute;top: 165px;left: 1000px;" action="../../php/adminupcred.php" method="post">
                <div style="position: absolute;top: 100px;left: 50px;width: 690px;"><input class="border-white shadow form-control form-control-lg" type="text" size="25" style="font-family: Montserrat, sans-serif;font-size: 40px;" value="<?php echo $_username ?>" name="admusr" placeholder="johnbuckle" readonly=""></div>
                <div style="position: absolute;top: 240px;left: 50px;width: 690px;"><input class="border-white shadow form-control form-control-lg" type="password" style="font-family: Montserrat, sans-serif;font-size: 40px;" placeholder="******" name="admpass" maxlength="16" minlength="6"></div>
                <div style="position: absolute;top: 400px;left: 50px;width: 690px;"><input class="border-white shadow form-control form-control-lg" type="password" style="font-family: Montserrat, sans-serif;font-size: 40px;" placeholder="******" required="" name="admreppass" maxlength="16" minlength="6"></div>
                <div style="position: absolute;top: 530px;left: 50px;width: 690px;"><button class="btn btn-primary btn-block border-white shadow" type="submit" style="background-color: #ffebc6;color: #f15946;font-family: Montserrat, sans-serif;font-size: 34px;font-weight: 600;padding-right: 50px;padding-left: 50px;border-radius: 30px;"><input type="hidden" name="aid" value="<?php echo $_GET['aid']; ?>"/>Save Changes</button></div>
                <div
