...
if (isset($_SESSION['amid']))
{
    ...
    '
        <script>
            ...
            window.location.href = "amaddflight.html";
...
<head>
    ...
    <title>Airport Manager Login</title>
    <meta name="description" content="Login to airport manager account">
    ...
    <div class="card">
        <div class="card-body" style="background-color: #F15946;height: 1000px;">
            ...
            <div class="container" style="position: absolute;top: 200px;left: 425px;width: 1000px;padding-left: 60px;">
                <h1 class="text-center" style="font-family: Montserrat, sans-serif;">Airport Management Login</h1>
            </div>
            <div class="container" style="position: absolute;top: 840px;left: 425px;width: 1000px;padding-left: 60px;">
                <h1 class="text-center" style="font-family: Montserrat, sans-serif;font-size: 20px;font-weight: 500;">Email EarlyBird to create an airport management account</h1>
            </div>
            ...
            <form style="position: absolute;top: 170px;left: 640px;min-width: 620px;" method = 'POST' action = '../../php/amlogin.php'>    
                <input class="border-white shadow form-control form-control-lg" type="text" style="font-family: Montserrat, sans-serif;font-size: 40px;position: absolute;top: 220px;left: 0px;" placeholder="johnbuckle" name = "mgruname" required="">
                <input class="shadow form-control form-control-lg"
                    type="password" style="position: absolute;top: 390px;left: 0px;font-family: Montserrat, sans-serif;font-size: 40px;" size="25" placeholder="********" name = "mgrpassword" required=""><a href="#start" style="font-family: Montserrat, sans-serif;font-weight: normal;font-style: normal;font-size: 24px;position: absolute;top: 530px;left: -10px;"></a>
                <button
                    class="btn btn-primary" type="submit" style="font-family: Montserrat, sans-serif;font-weight: normal;font-style: normal;font-size: 24px;position: absolute;top: 490px;left: -35px;background-color: rgba(0,123,255,0);border-color: rgba(255,255,255,0);"  value = 'LOGIN'><img src="../../assets/img/loginpage-red/signinmain.png"></button>
            </form>
        </div>
    </div>
    <footer>
